...
let BIBLIOTECA_LIVRO = {
    "form_space_order": {
        keywords: ["arquitetura", "forma", "espaço", "ordem", "ching", "proporção", "ritmo", "hierarquia", "simetria", "ponto", "linha", "comprimento", "direção", "posição", "plano", "largura", "comprimento", "volume", "profundidade"],
